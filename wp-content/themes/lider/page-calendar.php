                    ...
                    if (have_posts()) :
                        for ($timeTable = 6; $timeTable <= 23; $timeTable++) {
                            ...
                            if ($selLineCLCountN != 0) {
                                ?>
                                <tr>
                                    <td class="vertMid"><b><?php echo $timeTableText ?></b></td>
                                    ...
                                    for ($timeTable = 6; $timeTable <= 23; $timeTable++) {
                                        ...
                                        if ($selLineCLCount6 != 0) {
                                            for ($iCLV = 0; $iCLV < $selLineCLCount6; $iCLV++) {
                                                ...
                                                ?>
                                                <li class="card_line_tb time_line"><span
                                                        style="background: <?php echo $selLineCLcolorV->meta_value ?>"
                                                        class="marker"></span>
                                                    <span class="time"><?php echo $timeTableText ?></span>

                                                    <p class="description"><?php echo $val6[$iCLV]->item_content ?></p>
                                                </li>
                                            <?php
                                            }
                                        }
    ...
    <section class="section_tb info">
        <div class="section_line_lr conteiner">
            ...
            while (have_posts()) : the_post();
                ...
                ?>
                <h2>Дополнительная информация о расписании</h2>
                <?php if ($image_url[0]) { ?>
